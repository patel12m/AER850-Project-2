...
model = Sequential([
    ...
    Dropout(0.5),
    Dense(train_generator.num_classes, activation='softmax')  # Set the output layer to match the number of classes
])
...
# Save the model
model_save_path = '/content/drive/MyDrive/Project 2 Data/Perfectmodel.h5'
